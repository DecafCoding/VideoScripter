...
{
    /// <inheritdoc />
    public partial class useulong : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadsPlaylistId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelCategories", x => new { x.CategoriesId, x.ChannelsId });
                    table.ForeignKey(
                        name: "FK_ChannelCategories_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelCategories_Channels_ChannelsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelCategories_ChannelsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranscriptTopics_IsDeleted",
